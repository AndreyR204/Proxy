...
class ProxyRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_CONNECT(self):
        if os.path.isfile(self.cakey) and os.path.isfile(self.cacert) \
        ...
        with self.lock:
            if not os.path.isfile(certpath):
                ...
                p1 = Popen(["openssl", "req", "-new", "-key", self.certkey,
                            "-subj", "/CN={}".format(hostname)], stdout=PIPE)
                p2 = Popen(["openssl", "x509", "-req", "-days", "3650", "-CA",
                            self.cacert, "-CAkey", self.cakey, "-set_serial",
                            epoch,
                            "-out", certpath], stdin=p1.stdout, stderr=PIPE)
                p2.communicate()

        self.wfile.write("{} {} {}\r\n".format(self.protocol_version, 200,
    ...
    def send_cacert(self):
        ...
        self.wfile.write("{} {} {}\r\n".format(self.protocol_version, 200, 'OK').encode('latin_1'))
